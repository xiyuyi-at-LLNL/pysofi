...
class TestFinterp(unittest.TestCase):
    ...
    @data({'xrange': 4, 'yrange': 4, 'interp_num': 3, 'ifx': np.array([[0.25, 0.25, 0.25, 0.25],
                                                                       [0.25, 0.21650635+0.125j, 0.125-0.21650635j, 0.21650635-0.125j],
                                                                       [0.25, 0.125+0.21650635j, -0.125-0.21650635j, 0.125-0.21650635j],
                                                                       [0.25, 0+0.25j, -0.25, 0-0.25j],
                                                                       [0.25, -0.125+0.21650635j, -0.125+0.21650635j, -0.125-0.21650635j],
                                                                       [0.25, -0.21650635+0.125j, 0.125+0.21650635j, -0.21650635-0.125j],
                                                                       [0.25, -0.25, 0.25, -0.25],
                                                                       [0.25, -0.21650635-0.125j, 0.125-0.21650635j, -0.21650635+0.125j],
                                                                       [0.25, -0.125   -0.21650635j, -0.125-0.21650635j, -0.125+0.21650635j],
                                                                       [0.25, -0-0.25j, -0.25, 0+0.25j]]),
                                                      'ify': np.array([[0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25],
                                                                       [0.25, 0.21650635+0.125j, 0.125+0.21650635j, 0+0.25j, -0.125+0.21650635j, -0.21650635+0.125j, -0.25, -0.21650635-0.125j, -0.125-0.21650635j, -0-0.25j],
                                                                       [0.25, 0.125-0.21650635j, -0.125-0.21650635j, -0.25, -0.125+0.21650635j, 0.125+0.21650635j, 0.25, 0.125-0.21650635j, -0.125-0.21650635j, -0.25],
                                                                       [0.25, 0.21650635-0.125j, 0.125-0.21650635j, 0-0.25j, -0.125-0.21650635j, -0.21650635-0.125j, -0.25, -0.21650635+0.125j, -0.125+0.21650635j,0+0.25j]])})
    @unpack
